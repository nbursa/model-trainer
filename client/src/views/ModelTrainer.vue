  ...
  <div class="max-w-2xl mx-auto p-4 pb-24 font-light">
    ...
    <form @submit.prevent="trainModel" class="space-y-6">
      ...
      <div>
        ...
        <select v-model="modelType" id="modelType" class="block w-full px-3 py-2 border border-gray-900 bg-gray-950 rounded-md shadow-sm focus:outline-none sm:text-sm">
    ...
    <div v-if="score !== null" class="mt-6">
      ...
      <div class="flex flex-col sm:flex-row items-start justify-center text-sm pl-4">
        <div class="w-full sm:w-1/2 sm:mr-22">
    ...
    <div v-if="modelData.length > 0" class="mt-6">
      ...
      <select v-model="xFeature" id="xFeature" class="block w-full px-3 py-2 border border-gray-900 bg-gray-950 rounded-md shadow-sm focus:outline-none sm:text-sm">
